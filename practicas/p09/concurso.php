...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		...
		<ul>
    		<li><strong>Color:</strong> <em><?php echo $_POST['color']; ?></em></li> <!-- Asegúrate de que 'color' es el nombre -->
    		<?php
    		...
    		?>
    	<li><strong>Talla:</strong> <em><?php echo $_POST['size']; ?></em></li> <!-- Cambia 'talla' por 'size' -->
		</ul>
